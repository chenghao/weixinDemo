package com.hao.weixin.face.service;
...
import com.hao.weixin.face.pojo.Face;
...
public class FaceService {
	...
	private static List<Face> faceDetect(String picUrl) {
		...
		try {
			...
			queryUrl = queryUrl.replace("API_KEY", "6275292f9b91559205b45e6e98de3546");
			queryUrl = queryUrl.replace("API_SECRET", "haugjGwsaQ8e9eMH2KLS_zzJnlLWjK6C");
			// 调用人脸检测接口
