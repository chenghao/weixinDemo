package com.hao.weixin.music.service;
...
public class BaiduMusicService {
	...
	public static Music searchMusic(String musicTitle, String musicAuthor) {
		...
		// 对音乐名称、作者进URL编码
		requestUrl = requestUrl.replace("{TITLE}", UrlUTF8Util.urlEncodeUTF8(musicTitle));
		requestUrl = requestUrl.replace("{AUTHOR}", UrlUTF8Util.urlEncodeUTF8(musicAuthor));
		// 处理名称、作者中间的空格
